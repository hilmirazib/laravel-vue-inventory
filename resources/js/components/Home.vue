<template>
 ...
 <div class="h5 mb-0 font-weight-bold text-gray-800">{{ toRupiah(todaysell) }}</div>
        ...
        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ toRupiah(income) }} </div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="product in products" :key="product.id">
                        ...
                        <td>{{ toRupiah(product.buying_price) }}</td>
