                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 mb-4">
                      ...
                      <div class="card">
                        ...
                        <div class="table-responsive">
                          <ul class="list-group">
                            <li class="list-group-item"><b>Sub Total :</b> {{ toRupiah(orders.sub_total) }} </li>
                            <li class="list-group-item"><b>Vat :</b> {{ toRupiah(orders.vat) }}</li>
                            <li class="list-group-item"><b>Total :</b> {{ toRupiah(orders.total) }}</li>
                            <li class="list-group-item"><b>Pay Amount :</b> {{ toRupiah(orders.pay) }}</li>
                            <li class="list-group-item"><b>Due Amount :</b> {{ toRupiah(orders.due) }}</li>
                          </ul>
                        </div>
                        <div class="card-footer"></div>
                      </div>
                          ...
                          <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                              <tr v-for="detail in details">
                                ...
                                <td>{{ toRupiah(detail.product_price) }} </td>
                                <td>{{ toRupiah(detail.sub_total) }}</td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
